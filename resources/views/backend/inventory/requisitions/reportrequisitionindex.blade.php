                ...
                <div class="row">
                    <div class="col-sm-8">
                        <ul>
                            ...
                            <li class="active">Print Requisitions</li>
                        </ul><!-- end breadcrumb -->
                    </div><!-- end col -->
                </div><!-- end row -->
            </div><!-- end container -->
        ...
        <div class="container spark-screen">
            <div class="row">
                <div class="col-md-4 col-md-offset-4 col-sm-4 text-center">
                    <br/>
                    <div><h3>PRINT PRODUCT REQUISITIONS</h3></div>
...
<script>
    ...
    $('#requsistion-table').on('click', '.btn-print[data-remote]', function (e) {
        e.preventDefault();
