        ...
        <div class="container spark-screen">
            <div class="row">
                <div class="col-md-4 col-md-offset-4 col-sm-4 text-center">
                    <br/>
                    <div><h3>CREDIT CUSTOMERS</h3></div>
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="pull-left">
                ...
                <button type="button" class="btn btn-new btn-success"><i class="glyphicon glyphicon-plus"></i>New</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h3 class="modal-title" id="modal-register-label">New Customer</h3>
                </div>
                <form class="form-horizontal" role="form" method="POST" action="{{ url('customers.data.new') }}">
                    {{ csrf_field() }}
