    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="pull-left">
                ...
                <button type="button" class="btn btn-new btn-success">New Color</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="modal-register" tabindex="-1" role="dialog" data-backdrop="false" aria-labelledby="modal-register-label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url('admin.color.add') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Product Color</label>
