    ...
    <div class="modal fade" id="modal-register" tabindex="-1" role="dialog" data-backdrop="false" aria-labelledby="modal-register-label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin.unit.add') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group{{ $errors->has('formal_name') ? ' has-error' : '' }}">
                            <label for="formal_name" class="col-md-4 control-label">{!! trans('label.formal_name') !!}</label>

                            <div class="col-md-6">
                                <input id="formal_name" type="text" class="form-control" name="formal_name" value="" required>
                        ...
                        <div class="form-group{{ $errors->has('no_of_decimal_places') ? ' has-error' : '' }}">
                            <label for="no_of_decimal_places" class="col-md-4 control-label">Decimal Places</label>

                            <div class="col-md-6">
                                <input id="no_of_decimal_places" type="text" class="form-control" name="no_of_decimal_places" value="" required>
...
//                        trHTML += '<tr class="tabonedata"><td align="left">' + item.productCode + '</td><td>' +  item.name + '</td><td align="right">' + item.onhand + '</td></tr>';
                        ...
                        $('[id="formal_name"]').val(item.formal_name);
                        $('[id="no_of_decimal_places"]').val(item.no_of_decimal_places)
                        $('[id="id"]').val(item.id);
