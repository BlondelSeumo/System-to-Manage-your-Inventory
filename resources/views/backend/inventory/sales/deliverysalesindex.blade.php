...
@section('content')
        ...
        <div class="container spark-screen">
            <div class="row">
                <div class="col-md-6 col-md-offset-2">
                    <br/>
                    <div><h3>Delivery Sales : {!! $invoiceno !!}</h3></div>
                    ...
                    <div class="search" id="search">
                        <br/>
                        {!! Form::open(['url'=>'delivery.invoice.index', 'method' => 'GET']) !!}
    ...
    <?php $item_row = 0; ?>
    @if(!empty($data))
        {!! Form::open(['url'=>'delivery.invoice.create']) !!}
        {{ csrf_field() }}
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="items">
                    ...
                    <tr style="background-color: #f9f9f9;">
                        ...
                        <th width="20%" class="text-left">Invoice Qty</th>
                        <th width="20%" class="text-right">Delivery Qty</th>
                    ...
                    @foreach($data->items as $i=>$row)
                        ...
                        <tr id="item-row-{{ $item_row }}">
                            ...
                            <td>
                                <span>{!! $row->quantity !!} {!! $row->item->unit_name !!}</span>
                            </td>
                            <td>
