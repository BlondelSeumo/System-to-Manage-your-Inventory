...
{
    $compName = \App\Models\Common\Company::query()->where('id',Auth::guard('admin')->user()->company_id)->value('comp_name');
    return $compName;
}

function get_company_address()
{
    $company = \App\Models\Common\Company::query()->where('id',Auth::guard('admin')->user()->company_id)->first();
