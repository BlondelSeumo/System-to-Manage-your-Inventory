...
use app\Util\Base\Redirectors\ErrorAction;
use app\Util\Base\Redirectors\SuccessAction;
...
{
    use SuccessAction, AuthorizesRequests, DispatchesJobs, ValidatesRequests, ErrorAction;
